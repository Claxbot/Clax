...
const api = 'http://api.openweathermap.org/data/2.5/weather?q=' + args[0] + '&appid=9085d68629e6d57983a2c93a8fa2cd66';
 ...
 if (mesaj.length < 1) return message.reply(':x:Bir şehir ismi yazmalsınız.');
 try {
...
return text;
    ...
    .setDescription('Bir hata ile karşılaştık : \n`' + e.message + '`')
      console.log("LOG: Hava Durumu komutu " + message.author.username + '#' + message.author.discriminator + " tarafından kullanıldı.")
...
exports.help = {
  name: 'hava-durumu',
  description: 'Bot yazdığınız şehirin hava durumunu gösterir.',
  usage: 'hava-durumu [şehir]'
};